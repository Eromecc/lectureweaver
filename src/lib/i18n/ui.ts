...
const ENGLISH_UI_MESSAGES = {
  ...
  "upload.description":
    "Choose PDF slides, Markdown notes, and a transcript TXT file, pasted transcript text, or a lecture recording. Text is parsed in this tab; audio is sent only after you explicitly request transcription.",
  "upload.privacy":
...
const SIMPLIFIED_CHINESE_UI_MESSAGES = {
  ...
  "upload.description":
    "请选择 PDF 幻灯片、Markdown 笔记，以及 TXT 讲稿、粘贴的讲稿文本或课堂录音。文本会在当前浏览器标签页中解析；只有在你明确要求转写时才会发送音频。",
  "upload.privacy":
...
const JAPANESE_UI_MESSAGES = {
  ...
  "hero.featureParsing": "PDF と Markdown を実際にローカル解析",
  ...
  "upload.description":
    "PDF スライド、Markdown ノートと、TXT 文字起こし、貼り付けた文字起こしテキスト、または講義録音を選択してください。テキストはこのタブ内で解析され、音声は明示的に文字起こしを実行した場合にのみ送信されます。",
  "upload.privacy":
  ...
  "source.slidesTitle": "スライド",
  "source.slidesDetail": "テキストベース PDF",
  "source.slidesLimit": "最大 10 MiB",
  ...
  "pipeline.validatingAudioSources": "スライド、ノート、タイムスタンプ付き文字起こしを検証中…",
  "pipeline.validatingTextSources": "3 つのローカルファイルを検証中…",
  "pipeline.extractingAudioSources": "ページを抽出し、検証済み文字起こしのタイムスタンプを関連付け中…",
  "pipeline.extractingTextSources": "ページと段落構造を抽出中…",
...
const KOREAN_UI_MESSAGES = {
  ...
  "hero.featureParsing": "PDF와 Markdown을 실제로 로컬 분석",
  ...
  "upload.description":
    "PDF 슬라이드, Markdown 노트와 TXT 전사문, 붙여넣은 전사문 텍스트 또는 강의 녹음을 선택하세요. 텍스트는 이 탭에서 분석되며, 오디오는 사용자가 명시적으로 전사를 요청할 때만 전송됩니다.",
  "upload.privacy":
  ...
  "source.slidesTitle": "슬라이드",
  "source.slidesDetail": "텍스트 기반 PDF",
  "source.slidesLimit": "최대 10 MiB",
  ...
  "pipeline.validatingAudioSources": "슬라이드, 노트, 타임스탬프 전사문 검증 중…",
  "pipeline.validatingTextSources": "로컬 파일 3개 검증 중…",
  "pipeline.extractingAudioSources": "페이지를 추출하고 검증된 전사 타임스탬프 연결 중…",
  "pipeline.extractingTextSources": "페이지와 단락 구조 추출 중…",
